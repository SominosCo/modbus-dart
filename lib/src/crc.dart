...
const List<int> modbusCrcTable = [
  0X0000, 0XC0C1, 0XC181, 0X0140, 0XC301, 0X03C0, 0X0280, 0XC241, // Keep table
...
ByteBuffer modbusCRC(ByteBuffer inBuffer) {
  ...
  for (final _ in inBuffer.asUint8List()) {
    ...
    nCRC
      ...
      ..setUint16(0, nCRC.getUint16(0) ^ modbusCrcTable[temp.getUint8(0)]);
  }
  return nCRC.buffer;
}
